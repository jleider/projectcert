...
interface S { usps: string; history?: H[]; [k: string]: unknown; }
...
const add = (s: S, row: H): boolean => {
  s.history ??= [];
  if (s.history.some((r) => r.date === row.date && r.title === row.title)) return false;
  s.history.push(row);
...
// CA × 4
{
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://www.oyez.org/cases/1973/72-6520", "https://supreme.justia.com/cases/federal/us/414/563/"],
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=201720180AB2735"],
...
// MA × 2
{
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://www.doe.mass.edu/edprep/domains/instruction/bilingual-ed-endorsement.html"],
...
// OH × 1
{
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://www.legislature.ohio.gov/legislation/legislation-summary?id=GA135-HB-33"],
...
// TX × 2
{
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://tea.texas.gov/about-tea/laws-and-rules/sboe-rules-tac/sboe-rules-tac-april-2020/coversheet-9020.pdf"],
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://capitol.texas.gov/BillLookup/History.aspx?LegSess=88R&Bill=HB1414"],
...
// VA × 2
{
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://law.lis.virginia.gov/vacode/title22.1/chapter13.2/section22.1-212.1/"],
  ...
  if (add(s, {
    ...
    sourceUrls: ["https://law.lis.virginia.gov/admincode/title8/agency20/chapter23/section321/"],
...
{
  const s = load("VT");
  const ed = "https://education.vermont.gov/educator-licensure/professional-standards/licensing-endorsement-areas";
  if (add(s, {
    date: "2018-06-01",
